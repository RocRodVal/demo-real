...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="gestion-incidencia.php">Ver &raquo;</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>                       
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestión incidencia</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX"><td>Robo</td><td>26000975</td><td>Cambio terminal por robo</td><td>En proceso</td><td>14-01-2015</td></tr>
                                        <tr class="odd gradeX"><td>Avería</td><td>26000978</td><td>Cambio terminal</td><td>En proceso</td><td>10-01-2015</td></tr>
                                    </tbody>
                                </table>
                            </div>
                            <!-- /.table-responsive -->
