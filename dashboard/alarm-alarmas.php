                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active">
                                    ...
                                    <ul class="nav nav-third-level">
                                        ...
                                        <li>
                                            <a class="active" href="alarm-alarmas.php">Alarmas &raquo;</a>
                                        </li>
                                    </ul>
                                    <!-- /.nav-third-level -->
                                </li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                        ...
                        $xcrud->label('type_alarm','Tipo')->label('brand_alarm','Fabricante')->label('alarm','Modelo')->label('picture_url','Foto')->label('description','Comentarios')->label('status','Estado');
                        $xcrud->columns('type_alarm,brand_alarm,alarm,status');
                        $xcrud->fields('type_alarm,brand_alarm,alarm,picture_url,description,status');
                        echo $xcrud->render();
                    ?>
                </div>
            </div>                    
