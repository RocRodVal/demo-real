                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="maestro-contactos.php">Contactos &raquo;</a>
                                </li>                                
                                <li>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>FOCUS</td>
                                            <td>Administrador</td>
                                            <td><a href="mailto:bcn@focusonemotions.com">bcn@focusonemotions.com</a></td>
                                        </tr>
                                        <tr>
                                            <td>Orange</td>
                                            <td>Agente Naranja</td>
                                            <td><a href="mailto:info@orange.es">info@orange.es</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
