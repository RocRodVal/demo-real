...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="maestro-displays.php">Displays &raquo;</a>
                                </li>
                                <li>
                                    <a href="maestro-dispositivos.php">Dispositivos &raquo;</a>
                                </li>                               
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>                          
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Displays</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                        ...
                        $xcrud->label('client_display','Cliente')->label('type_pds','Tipo punto de venta')->label('display','Modelo')->label('picture_url','Foto')->label('canvas_url','SVG')->label('description','Comentarios')->label('positions','Posiciones')->label('status','Estado');
                        $xcrud->columns('client_display,type_pds,display,positions,status');
                        $xcrud->fields('client_display,type_pds,display,picture_url,canvas_url,description,positions,status');
                        echo $xcrud->render();
                    ?>
                </div>
            </div>                
