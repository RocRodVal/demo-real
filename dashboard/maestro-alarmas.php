                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="maestro-alarmas.php">Alarmas &raquo;</a>
                                </li>                                 
                                <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php
                        ...
                        $xcrud_3->label('type_alarm','Tipo')->label('brand_alarm','Fabricante')->label('alarm','Modelo')->label('picture_url','Foto')->label('description','Comentarios')->label('status','Estado');
                        $xcrud_3->columns('type_alarm,brand_alarm,alarm,status');
                        $xcrud_3->fields('type_alarm,brand_alarm,alarm,picture_url,description,status');
                        echo $xcrud_3->render();
                    ?>
                </div>
            </div>                
