...
(function ($) {
    ...
    FileInput.prototype = {
        ...
        renderUpload: function () {
            ...
            if (!self.isUploadable || self.isDisabled) {
                //TODO texto comentado para evitar el submit del pluging y mantener el del formulario
    ...
    $.fn.fileinput.defaults = {
        ...
        browseLabel: 'Seleccionar archivo &hellip;',
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) excede del máximo tamaño permitido <b>{maxSize} KB</b>. Por favor, intentelo otra vez!',
        msgFilesTooMany: 'El número de archivos adjuntados <b>({n})</b> excede el máximo permitido <b>{m}</b>. Por favor, intentelo otra vez!',
        msgFileNotFound: 'Archivo "{name}" no encontrado!',
        msgFileSecured: 'Security restrictions prevent reading the file "{name}".',
        msgFileNotReadable: 'El archivo "{name}" no se puede leer.',
        msgFilePreviewAborted: 'File preview aborted for "{name}".',
        msgFilePreviewError: 'Se ha producido un error al leer el archivo "{name}".',
        msgInvalidFileType: 'Invalid type for file "{name}". Only "{types}" files are supported.',
        msgInvalidFileExtension: 'Invalid extension for file "{name}". Only "{extensions}" files are supported.',
        msgValidationError: '<span class="text-danger"><i class="glyphicon glyphicon-exclamation-sign"></i>Error al enviar el archivo</span>',
