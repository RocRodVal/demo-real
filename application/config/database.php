...
$db['dev']['username'] = 'demoreal';
$db['dev']['password'] = 'arf2t24t23r13$12';
$db['dev']['database'] = 'demoreal';
...
$db['pre']['dbprefix'] = '';
$db['pre']['pconnect'] = TRUE;
$db['pre']['db_debug'] = TRUE;
$db['pre']['cache_on'] = FALSE;
$db['pre']['cachedir'] = '';
$db['pre']['char_set'] = 'utf8';
$db['pre']['dbcollat'] = 'utf8_general_ci';
$db['pre']['swap_pre'] = '';
$db['pre']['autoinit'] = TRUE;
$db['pre']['stricton'] = FALSE;

$db['pro']['hostname'] = 'localhost';
$db['pro']['username'] = 'demoreal';
$db['pro']['password'] = 'arf2t24t23r13$12';
$db['pro']['database'] = 'demoreal';
