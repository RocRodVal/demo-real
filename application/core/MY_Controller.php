...
class MY_Controller extends CI_Controller
{
    ...
    public function login()
    {
        ...
        $config = array (
            array('field' => 'sfid-login', 'label'=> 'SFID', 'rules' => 'trim|required', 'errors'=> array('required'=> '%s es requerido') ),
            array( 'field' => 'password', 'label'=> 'Password', 'rules' => 'trim|required',  'errors'=> array( 'required'=> '%s es requerido') )
        );
