		                    ...
		                    <table class="table table-striped table-bordered table-hover table-sorting" id="table_incidencias_dashboard" data-order-form="form_orden_activas">
		                        ...
		                        foreach ($incidencias as $incidencia) {
		                            ...
		                            <tr>
		                                ...
		                                <td  onClick="window.location.href='<?=site_url('admin/operar_incidencia/'.$incidencia->id_incidencia.'/'.$incidencia->id_pds)?>'"><a href="<?=site_url('admin/operar_incidencia/'.$incidencia->id_incidencia.'/'.$incidencia->id_pds)?>#chat"><strong><i class="fa fa-whatsapp <?=($incidencia->nuevos['nuevos']<>'0')?'chat_nuevo':'chat_leido'?>"></i></strong></a></td>
		                            </tr>
		                        <?php
		                        }
		                        ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row filtro">
                            <form action="<?=base_url()?>admin/dashboard/#incidencias_cerradas" method="post" class="filtros">
                        ...
                        if (empty($incidencias_finalizadas)) {
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="<?=base_url()?>admin/dashboard/#incidencias_cerradas" method="post" id="form_orden_cerradas">
