		...
		<div id="page-wrapper">
            ...
            <div class="row buscador">
                <form action="<?=site_url('admin/informe_pdv');?>" method="post" class="form-inline filtros form-mini">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                            <?php   if($generado===TRUE)    {?>
                                <a href="<?=base_url("admin/informe_pdv/reset")?>" class="reiniciar_busqueda"> <i class="glyphicon glyphicon-remove"></i> Resetear informe</a>
                            <?php } ?>
                        </div>
            ...
            <div class="row">
                <?php
                     if(is_null($resultados)){
                         ...
                         <p><a href="<?=base_url()?>admin/informe_pdv_exportar" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
