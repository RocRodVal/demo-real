...
<head>
    ...
    <?php if($this->uri->segment(2)==="dashboard"){?>
        ...
        <script src="<?=site_url('assets/js/plugins/Highcharts/highcharts.js')?>"></script>
        <script src="<?=site_url('assets/js/plugins/Highcharts/modules/exporting.js')?>"></script>
        <script src="<?=site_url('assets/js/plugins/Highcharts/highcharts-3d.js')?>"></script>
        <script src="<?=site_url('assets/js/dashboard/dashboard.js')?>"></script>
    <?php }?>
    <?php if($this->uri->segment(2)==="dashboard_pds"){?>
        ...
        <script src="<?=site_url('assets/js/plugins/tooltipster/jquery.tooltipster.js')?>"></script>
        <script src="<?=site_url('assets/js/dashboard/dashboard_pds.js')?>"></script>
    <?php }?>
    <?php if($this->uri->segment(2)==="operar_incidencia"){?>
        <script type="text/javascript" src="<?=site_url('assets/js/intervencion/addIntervencion.js')?>"></script>
        ...
        <script src="<?=site_url('assets/js/plugins/dataTables/jquery.dataTables.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/plugins/dataTables/dataTables.bootstrap.js')?>" type="text/javascript"></script>
    <?php }?>
    ...
    <?php if($this->uri->segment(2)==="alta_incidencia_robo"){?>
        ...
        <script src="<?=site_url('assets/js/plugins/fileInput/fileInput.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/plugins/growl/bootstrap-growl.min.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/incidencia/alta_robo.js')?>" type="text/javascript"></script>
    <?php }?>
    ...
    <?php if($this->uri->segment(1)==="intervencion"){?>
        ...
        <script src="<?=site_url('assets/js/plugins/dataTables/jquery.dataTables.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/plugins/dataTables/dataTables.bootstrap.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/bootstrap-tooltip.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/bootstrap-confirmation.js')?>" type="text/javascript"></script>
        <script src="<?=site_url('assets/js/intervencion/intervencion.js')?>" type="text/javascript"></script>
    <?php }?>
</head>  
