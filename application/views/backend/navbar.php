            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" style="margin-top:20px;">
                        ...
                        <li><a <?=($this->uri->segment(2)==='incidencias_master')?'class="active"':''?> href="<?=site_url('admin/incidencias_master')?>"><i class="fa fa-wrench fa-fw"></i> Export incidencias Orange</a></li>
                        <?php 
                        }
                        else 
                        {
