            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu" style="margin-top:20px;">
                              ...
                              <?php /*  <li><a <?=($this->uri->segment(3)==='incidencias')?'class="active"':''?> href="<?=site_url($acceso.'/incidencias')?>"> Exportar todas &raquo;</a></li> */ ?>
                                ...
                                <li>
                                    <a <?=($this->uri->segment(2)==='ajustes' || $this->uri->segment(2)==='update_ajustes_totales')?'class="active"':''?>
                                        href="<?=site_url($acceso.'/ajustes')?>">Ajustes Interv / Dispos. &raquo;</a>
                                </li>
                        ...
                        <?php
                        $maestros = array('clientes','contactos','alarmas','dispositivos','muebles','displays','puntos_de_venta','categorias_pdv','razones_parada','soluciones_ejecutadas',
