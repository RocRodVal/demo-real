                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row filtro">
                            <form action="<?=base_url()?>territorio/estado_incidencias/cerradas" method="post" class="filtro form-mini">
                        ...
                        if (empty($incidencias)) {
                            ...
                            <p><a href="<?=base_url()?>territorio/exportar_incidencias/cerradas/xls" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
