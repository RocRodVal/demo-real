                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row filtro">
                            <form action="<?=base_url()?>terri/estado_incidencias/cerradas" method="post" class="filtro form-mini">
                                ...
                                <div class="col-sm-1">
                                    <?php /* if(! empty($buscar_sfid) || ! empty($buscar_incidencia)) { ?>
                                        <a href="<?=base_url()?>territorio/dashboard/borrar_busqueda/#incidencias_cerradas" class="reiniciar_busqueda"><i class="glyphicon glyphicon-remove"></i>  Reiniciar</a>
                                    <?php }*/ ?>
                                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-sorting" id="table_incidencias_cerradas"  data-order-form="form_orden_cerradas">
                                    ...
                                    foreach ($incidencias as $incidencia) {
                                        ?>
                                        <tr>
                                            <td><a href="<?=site_url('territorio/detalle_incidencia/'.$incidencia->id_incidencia.'/'.$incidencia->id_pds)?>">
