            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="row buscador">
                        <form action="<?=base_url()?>master/dashboard/#incidencias_abiertas" method="post" class="filtros">
                           <?php /* <div class="col-sm-2">
                            ...
                            <div class="col-sm-1">
                                <?php /* if(! empty($filtro) || ! empty($filtro_pds)) { ?>
                                    <a href="<?=base_url()?>master/dashboard/borrar_busqueda/#incidencias_abiertas" class="reiniciar_busqueda"><i class="glyphicon glyphicon-remove"></i>  Reiniciar</a>
                                <?php }*/ ?>
		            ...
		            <?php } else {
                        ...
                        <p><a href="<?=base_url()?>master/dashboard_exportar/abiertas" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
		                <div class="table-responsive">
                            ...
                            <form action="<?=base_url()?>master/dashboard/#incidencias_abiertas" method="post" id="form_orden_activas">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row filtro">
                            <form action="<?=base_url()?>master/dashboard/#incidencias_cerradas" method="post" class="filtros">
                                ...
                                <div class="col-sm-1">
                                    <?php /* if(! empty($filtro_finalizadas) || ! empty($filtro_finalizadas_pds)) { ?>
                                        <a href="<?=base_url()?>master/dashboard/borrar_busqueda/#incidencias_cerradas" class="reiniciar_busqueda"><i class="glyphicon glyphicon-remove"></i>  Reiniciar</a>
                                    <?php }*/ ?>
                        ...
                        if (empty($incidencias_finalizadas)) {
                            ...
                            <p><a href="<?=base_url()?>master/dashboard_exportar/cerradas" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
                            <div class="table-responsive">
                                ...
                                <form action="<?=base_url()?>master/dashboard/#incidencias_cerradas" method="post" id="form_orden_cerradas">
