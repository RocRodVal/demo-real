        ...
        <div id="page-wrapper">
            <div class="row">
		        <div class="col-lg-12">
		            <h1 class="page-header"><?php echo $ayuda_title ?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="<?php echo base_url(); ?>assets/manuales/manual_usuario_gsp-SmartStore.pdf" target="_blank">Manual sistemas de seguridad Smart Store</a><br />
                </div>
            </div>
        </div>
        <!-- /#page-wrapper -->
