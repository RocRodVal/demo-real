...
<head>
    ...
    <title><?= lang('comun.titulo') ?> &gt; Tiendas Propias &gt; <?php if (isset($title)): ?><?= $title ?><?php else: ?>Mis incidencias<?php endif; ?></title>
    ...
    <?= Xcrud::load_js(); ?>
    <!--[if lt IE 9]>
    <script src="<?php echo base_url(); ?>assets/js/explorer/html5shiv.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url(); ?>assets/js/explorer/respond.min.js" type="text/javascript"></script>
    <![endif]-->
