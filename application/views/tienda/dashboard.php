            ...
            <div class="row" >
                <div class="col-lg-12">
		            ...
		            <?php } else {
                        ...
                        <p><a href="<?=base_url()?>tienda/dashboard_exportar/abiertas" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
		                <div class="table-responsive">
		                    <table class="table table-striped table-bordered table-hover table-sorting" id="table_incidencias_dashboard" data-order-form="form_orden_activas">
		                        ...
		                        foreach ($incidencias as $incidencia) {
		                            ...
		                            <tr>
		                                ...
		                                <td  onClick="window.location.href='<?=site_url('tienda/detalle_incidencia/'.$incidencia->id_incidencia.'/'.$incidencia->id_pds)?>'"><a href="<?=site_url('tienda/operar_incidencia/'.$incidencia->id_pds.'/'.$incidencia->id_incidencia)?>#chat"><strong><i class="fa fa-whatsapp <?=($incidencia->nuevos['nuevos']<>'0')?'chat_nuevo':'chat_leido'?>"></i></strong></a></td>
		                            </tr>
		                        <?php
		                        }
		                        ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        if (empty($incidencias_finalizadas)) {
                            ...
                            <p><a href="<?=base_url()?>tienda/dashboard_exportar/cerradas" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
                            <div class="table-responsive">
