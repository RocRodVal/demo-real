            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="col-lg-12">
                        ...
                        ?>
                            <p><a href="<?=base_url()?>tienda/exportar_pedidos/<?=$tipo?>/xls" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a></p>
                                ...
                                foreach ($pedidos as $pedido) {
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <a href="<?=site_url('tienda/detalle_pedido/'.$pedido->id.'/'.$pedido->id_pds)?>">
