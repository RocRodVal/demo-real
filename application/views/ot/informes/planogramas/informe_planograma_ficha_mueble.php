            ...
            <div class="row">
		    	<h1 class="page-header"><?php echo $subtitle ?>
		        	<a onclick="location.href='<?=site_url("ot/informe_planogramas/")?>'" class="btn btn-danger right">Volver</a>
		        </h1>
            </div>
            <div class="row">
 					<?php
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="list-group">
										...
										{
										?>
										<a class="list-group-item" href="<?=site_url('ot/informe_planograma_terminal/'.
