							...
							foreach($displays as $display){
								if($display->devices_count != 0){
									...
									if ($display->picture_url != '')
									{
										...
										<a href="<?=site_url('ot/informe_planograma_mueble_pds')?>/<?php echo $display->id_pds.'/'.$display->id_displays_pds ?>">
									...
									<?php
										...
										?>
										<a href="<?=site_url('ot/informe_planograma_mueble_pds')?>/<?php echo $display->id_pds.'/'.$display->id_display ?>"><?php echo strtoupper($display->display) ?></a><br clear="all" />
									<?php
									}
									?>
									</div>
