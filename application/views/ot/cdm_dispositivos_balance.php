        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="filtro">
                        <form action="<?=base_url()?>ot/cdm_dispositivos_balance" method="post" class="filtros form-mini autosubmit col-lg-12">
                            <div class="col-lg-2">
                            ...
                            <div class="form-group">
                                <a href="<?=base_url()?>ot/cdm_dispositivos_balance/borrar_busqueda" class="reiniciar_busqueda form-control input-sm">Reiniciar</a>
                            </div>
