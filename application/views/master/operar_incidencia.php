                ...
                <div class="panel-body incidenciaEstado">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 labelBtn grey">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/2/2') ?>"
                               classBtn="status_1/2" class="btn btn-success" <?php if ($incidencia['status'] != 'Nueva') {
                                echo 'disabled';
                            } ?>>Revisar</a>
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/5/9') ?>"
                        ...
                        <div class="col-lg-5 labelBtn white">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/2/3') ?>"
                        ...
                        <div class="col-lg-5 labelBtn white">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/3/5') ?>"
                        ...
                        <div class="col-lg-5 labelBtn grey">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/4/6') ?>"
                        ...
                        <div class="col-lg-5 labelBtn white">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/4/7') ?>"
                        ...
                        <div class="col-lg-5 labelBtn grey">
                            <a href="<?= site_url('master/update_incidencia/' . $id_pds_url . '/' . $id_inc_url . '/4/8') ?>"
