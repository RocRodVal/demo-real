							...
							foreach($displays as $display){
								if($display->devices_count != 0){
									...
									if ($display->picture_url != '')
									{
										...
										<a href="<?=site_url('master/planograma_mueble')?>/<?php echo $display->id_pds.'/'.$display->id_display ?>">
									...
									<?php
										...
										?>
										<a href="<?=site_url('master/planograma_mueble')?>/<?php echo $display->id_pds.'/'.$display->id_display ?>"><?php echo $display->display ?></a><br clear="all" />
									<?php
									}
									?>
									</div>
