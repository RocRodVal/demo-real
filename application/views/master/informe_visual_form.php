                            ...
                            <div class="col-sm-12">
                                ...
                                <script>
                                    ...
                                    function cargar_panelados() {
                                        ...
                                        if (id_tipo_tienda != "") {
                                            $.post('<?php echo site_url()?>master/panelado_tienda/' + id_tipo_tienda+'/'+id_panelado,
                                                {},
                                                function (data) {
                                ...
                                <div class="form-group">
                                    <?php   if($generado_visual===TRUE)    {?>
                                        <a href="<?=base_url("master/informe_visual/reset")?>" class="reiniciar_busqueda"> <i class="glyphicon glyphicon-remove"></i> Resetear informe</a>
                                    <?php } ?>
                                </div>
