            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="filtro">
                        <form action="<?=base_url($controlador)?>/estado_incidencias/abiertas" method="post" class="filtros form-mini autosubmit col-lg-12">
                            ...
                            <div class="col-lg-1">
                                <div class="form-group">
                                    <a href="<?=base_url($controlador)?>/estado_incidencias/abiertas/borrar_busqueda" class="reiniciar_busqueda form-control input-sm">Reiniciar</a>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                ...
                <div class="col-lg-12">
		            ...
		            <?php } else {
                        ...
                        <p><a href="<?=base_url()?>master/exportar_incidencias/abiertas" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar Excel</a>
                            <a href="<?=base_url()?>master/exportar_incidencias/abiertas/xlsx/porrazon" class="btn exportar"><i class="glyphicon glyphicon-file"></i> Exportar por razon de parada</a></p>
		                <div class="table-responsive">
                            ...
                            <form action="<?=base_url()?>master/estado_incidencias/abiertas" method="post" id="form_orden">
