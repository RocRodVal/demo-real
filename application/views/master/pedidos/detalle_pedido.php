        ...
        <div class="col-lg-12">
            <h1 class="page-header"><?php echo $title ?>
                ...
                if (($status=='Finalizado') || ($status=='Cancelado')) {
                    ?>
                    <a href="<?=site_url('master/pedidos/finalizados') ?>" class="btn btn-danger right">Volver</a>
                <?php } else { ?>
                    <a href="<?=site_url('master/pedidos/abiertos')?>" class="btn btn-danger right">Volver</a>
        ...
        <div class="col-lg-5">
             <div class="panel panel-default">
                 <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <?php $this->load->view('master/pedidos/chat_pedido.php'); ?>
                        </div>
                        </div>
                     </div>
                 </div>
