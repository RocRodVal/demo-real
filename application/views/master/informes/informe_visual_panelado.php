							...
							foreach($displays as $display){
								if($display->devices_count != 0){
									...
									if ($display->picture_url != '')
									{
										...
										<a href="<?=site_url('master/informe_visual_mueble')?>/<?php echo $display->id_display?>">
									...
									<?php
										...
										?>
										<a href="<?=site_url('master/informe_visual_mueble')?>/<?php echo $display->id_display ?>"><?php echo strtoupper($display->display) ?></a><br clear="all" />
									<?php
									}
									?>
									</div>
