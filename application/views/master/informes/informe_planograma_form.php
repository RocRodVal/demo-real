		...
		<div id="page-wrapper">
            ...
            <div class="row buscador">
                <form action="<?=site_url('master/informe_planogramas');?>" method="post" class="form-inline filtros form-mini">
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                            <?php   if($generado_planograma===TRUE)    {?>
                                <a href="<?=base_url("master/informe_planogramas/reset")?>" class="reiniciar_busqueda"> <i class="glyphicon glyphicon-remove"></i> Resetear informe</a>
                            <?php } ?>
                        </div>
