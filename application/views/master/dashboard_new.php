            ...
            <div class="row" >
                <div class="col-lg-12">
                    <div class="row buscador">
                        <form action="<?=base_url()?>master/dashboard_new/#incidencias_abiertas" method="post" class="filtros">
                           <?php /* <div class="col-sm-2">
                            ...
                            <div class="col-sm-1">
                                <?php if(! empty($filtro) || ! empty($filtro_pds)) { ?>
                                    <a href="<?=base_url()?>master/dashboard_new/borrar_busqueda/#incidencias_abiertas" class="reiniciar_busqueda"><i class="glyphicon glyphicon-remove"></i>  Reiniciar</a>
                                <?php } ?>
		            ...
		            <?php } else {
		                ...
		                <div class="table-responsive">
                            ...
                            <form action="<?=base_url()?>master/dashboard_new/#incidencias_abiertas" method="post" id="form_orden_activas">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row filtro">
                            <form action="<?=base_url()?>master/dashboard_new/#incidencias_cerradas" method="post" class="filtros">
                                ...
                                <div class="col-sm-1">
                                    <?php if(! empty($filtro_finalizadas) || ! empty($filtro_finalizadas_pds)) { ?>
                                        <a href="<?=base_url()?>master/dashboard_new/borrar_busqueda/#incidencias_cerradas" class="reiniciar_busqueda"><i class="glyphicon glyphicon-remove"></i>  Reiniciar</a>
                                    <?php } ?>
                        ...
                        if (empty($incidencias_finalizadas)) {
                            ...
                            <div class="table-responsive">
                                ...
                                <form action="<?=base_url()?>master/dashboard_new/#incidencias_cerradas" method="post" id="form_orden_cerradas">
